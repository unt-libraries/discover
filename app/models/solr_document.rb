  ...
  def resource_type_map
    {
      ...
      :music_score => { :label => 'Music Score', :icon => 'list-music' },
      ...
      :educational_kit => { :label => 'Educational Kit', :icon => 'child' },
      :archival_collection => { :label => 'Archival Collection', :icon => 'archive' },
